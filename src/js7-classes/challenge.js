...
export class Engine {
   ...
   */
  startEngine() {
    if (this.engineIsRunning) return "Engine is already running";
    else {
  ...
  stopEngine() {
    ...
    } else return "Engine has already stopped running";
  }
}
...
export class BankAccount {
  ...
  deposit(amount) {
    ...
    const convertedToNumber = Number(amount);
  ...
  withdraw(amount) {
    ...
    if (convertedToNumber > this._balance) return "Insufficient funds, unable to withdraw";
